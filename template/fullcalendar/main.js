...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var DaySeriesModel = /** @class */ (function () {
        ...
        // Only modules for *start* dates of cells. Will not work for exclusive end dates for cells.
    ...
    */
    ...
    var Scroller = /** @class */ (function (_super) {
        ...
        Scroller.prototype.getXScrollbarWidth = function () {
            ...
            return this.el.offsetHeight - this.el.clientHeight; // only modules because we guarantee no borders. TODO: add to CSS with important?
        };
        Scroller.prototype.getYScrollbarWidth = function () {
            if (VISIBLE_HIDDEN_RE.test(this.props.overflowY)) {
                return 0;
            }
            return this.el.offsetWidth - this.el.clientWidth; // only modules because we guarantee no borders. TODO: add to CSS with important?
        };
        return Scroller;
    }(BaseComponent));
